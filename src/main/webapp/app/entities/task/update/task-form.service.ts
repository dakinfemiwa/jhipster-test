...
type TaskFormDefaults = Pick<NewTask, 'id' | 'dueDate' | 'isComplete' | 'isPublic'>;
...
type TaskFormGroupContent = {
  ...
  isComplete: FormControl<TaskFormRawValue['isComplete']>;
  isPublic: FormControl<TaskFormRawValue['isPublic']>;
...
export class TaskFormService {
  createTaskFormGroup(task: TaskFormGroupInput = { id: null }): TaskFormGroup {
    ...
    return new FormGroup<TaskFormGroupContent>({
      ...
      isComplete: new FormControl(taskRawValue.isComplete),
      isPublic: new FormControl(taskRawValue.isPublic),
